...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center' >
      ...
      <main>
        ...
        <div>
          ...
          <strong className='text-gray-100 text-xl'>
            <span className='text-ignite-500'>+{props.userCount}</span> já estão usando
          </strong>
        </div>
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo uma prévia do app mobile NLW Copa" />
    </div>
  )
}
